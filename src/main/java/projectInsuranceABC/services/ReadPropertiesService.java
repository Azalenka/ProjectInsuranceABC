package projectInsuranceABC.services;

import lombok.extern.slf4j.Slf4j;
import projectInsuranceABC.exceptions.PropertyReaderException;
...
public class ReadPropertiesService {
    ...
    public static Properties readDataSourceProperty() throws PropertyReaderException {
        try (InputStream inputStream = projectInsuranceABC.services.ReadPropertiesService.class.getClassLoader().getResourceAsStream(DATA_SOURCE_PROPERTY_PATH)) {
